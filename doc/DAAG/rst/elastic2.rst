...
stretched over the end of a ruler, the distance that the band traveled
when released. The ``elastic1`` data frame has 7 rows. The ``elastic2``
data frame, whose data span a wider range of stretches and distances,
has 9 rows.
