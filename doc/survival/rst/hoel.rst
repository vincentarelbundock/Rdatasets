...
``outcome``
   outcome: ``censor``, ``thymic lymphoma``, ``reticulum cell sarcoma``
   ``other causes``
...
Kalbfleisch and Prentice. The germ-free environment has little effect on
the rate of occurence of thymic lymphoma, but significantly delays the
...
risks. Biometrics 33, 1-30. Kalbfleisch, J.D. and Prentice, R.L. (1980).
