...
The dataset name has been changed to 'senaterace10_tbl_df' to avoid
...
state
   Character string indicating the U.S. state where the election took
   place.
...
perc1
   Numeric indicating the percentage of votes received by the first
   candidate.
...
perc2
   Numeric indicating the percentage of votes received by the second
   candidate.
...
perc3
   Numeric indicating the percentage of votes received by the third
   candidate.
...
perc4
   Numeric indicating the percentage of votes received by the fourth
   candidate.
...
perc5
   Numeric indicating the percentage of votes received by the fifth
   candidate.
...
Data on U.S. Senate races held in 2010, including candidates' names,
vote percentages, and party affiliations.
