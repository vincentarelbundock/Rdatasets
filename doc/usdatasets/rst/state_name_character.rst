...
The dataset name has been changed to 'state_name_character' to avoid
...
identifies it as a character vector. The original content of the dataset
...
A character vector with 50 observations representing the names of U.S.
states.
