...
``cesd``
   Center for Epidemiologic Studies Depression measure of depressive
   symptoms at baseline (higher scores indicate more symptoms)
...
``mcs``
   SF-36 Mental Component Score (measured at baseline, higher scores are
   better)

``pcs``
   SF-36 Physical Component Score (measured at baseline, higher scores
   are better)
