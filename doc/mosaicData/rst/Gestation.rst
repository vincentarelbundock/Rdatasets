...
``parity``
   total number of previous pregnancies (including fetal deaths and
   still births)
...
``smoke``
   does mother smoke? (never, smokes now, until current pregnancy, once
   did, not now)

``time``
   time since quitting smoking (never smoked, still smokes, during
   current preg, within 1 year, 1 to 2 years ago, 2 to 3 years ago, 3 to
   4 years ago, 5 to 9 years ago, 10+ years ago, quit and don't know

``number``
   number of cigarettes smoked per day for past and current smokers
   (never, 1-4, 5-9, 10-14, 15-19, 20-29, 30-39, 40-60, 60+, smoke but
   don't know)
