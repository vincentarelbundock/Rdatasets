...
presented with a bowl of one ``formula`` and the time to ``start``
eating and ``amount`` eaten were recorded.
...
effect of ``formula``, in that their sum of squares add to the overall
sum of squares.
