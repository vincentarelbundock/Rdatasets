...
result
   A factor indicating the result of the yawning observation (e.g.,
   yawned, did not yawn).

group
   A factor representing the group to which the participants belong
   (e.g., control, experimental).

Details
~~~~~~~

This dataset investigates the contagiousness of yawning. It includes
results from an experiment that examines whether individuals yawn more
when they are in the presence of someone else who is yawning, providing
insights into social behaviors and contagion phenomena.
