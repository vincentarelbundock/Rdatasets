...
smoke
   A factor indicating whether the respondent is a smoker (e.g., yes,
   no).
...
type
   A factor indicating the type of smoking behavior (e.g., occasional,
   regular).

Details
~~~~~~~

This dataset contains information on smoking habits in the UK, focusing
on various demographic factors and smoking behaviors. It provides
insights into smoking patterns among different groups of people, helping
