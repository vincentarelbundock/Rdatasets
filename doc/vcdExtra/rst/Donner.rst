...
Donner, Graves, Breen and Reed. The families of Murphy, Foster and Pike
are grouped as ``'MurFosPik'``, those of Fosdick and Wolfinger are coded
as ``'FosdWolf'``, and all others as ``'Other'``.
...
``donner`` in alr3, ``case2001`` in Sleuth2(adults only) provide similar
data sets.
