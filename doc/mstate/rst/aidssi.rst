...
| patnr:      | Patient identification number                          |
+-------------+--------------------------------------------------------+
| entry.time: | Time from HIV infection to cohort entry. Value is zero |
|             | if HIV infection occurred while in follow-up.          |
+-------------+--------------------------------------------------------+
...
+-------------+--------------------------------------------------------+
| si.stat:    | Event indicator with respect to SI switch, with values |
|             | 0 (no switch) and 1 (switch)                           |
+-------------+--------------------------------------------------------+
| death.time: | Time from HIV infection to death, or last follow-up if |
