...
retained
   a factor with levels ``0`` ``1`` indicating if the student has been
   retained in a grade.
...
lowinc
   a numeric vector giving the percentage of low-income students in the
   school
...
Raudenbush and Congdon, 1996). Conversion to the R format is described
in Doran and Lockwood (2004).

References
~~~~~~~~~~

Doran, Harold C. and Lockwood, J.R. (2004), *Fitting value-added models
in R*, (submitted).
