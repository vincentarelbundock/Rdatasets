...
- Cook FE (1938). *Chocolate cake, I. Optimum baking temperature*.
  Master's Thesis, Iowa State College.

- Cochran WG, Cox GM (1957). *Experimental Designs*, 2nd edition. John
  Wiley & Sons, New York.

- Lee Y, Nelder JA, Pawitan Y (2006). *Generalized linear models with
  random effects: unified analysis via H-likelihood*. Chapman and
  Hall/CRC, Boca Raton.
