...
it falling on any one area is ``p = 1/N``, and not falling on that area
is ``q = 1 - 1/N``. He derives the probability distribution of 0, 1, 2,
...
`30DayChartChallenge <https://github.com/drjohnrussell/30DayChartChallenge/blob/main/2025/Challenge28.R>`__
