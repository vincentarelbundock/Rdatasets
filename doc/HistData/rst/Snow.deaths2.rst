...
``SnowMap`` for code to draw Snow's map; ``Cholera`` for William Farr's
cholera data. The cholera package contains more analytical methods for
understanding Snow's cholera data.
