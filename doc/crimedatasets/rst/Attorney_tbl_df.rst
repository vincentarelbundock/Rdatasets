...
This dataset contains information on the number of convictions reported
by U.S. attorney's offices, along with the number of staff members,
normalized per 1 million population. The dataset also includes the
district names for each observation.
...
district
   Name of the district (character). Possible values include major U.S.
   cities such as Albuquerque, Atlanta, Boston, Chicago, Houston, Miami,
