...
The ``Orthodont`` data frame has 108 rows and 4 columns of the change in
...
Subject
   an ordered factor indicating the subject on which the measurement was
   made. The levels are labelled ``M01`` to ``M16`` for the males and
   ``F01`` to ``F13`` for the females. The ordering is by increasing
   average distance within sex.
