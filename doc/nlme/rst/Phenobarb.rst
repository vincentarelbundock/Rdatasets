...
Apgar
   an ordered factor giving the 5-minute Apgar score for the infant.
   This is an indication of health of the newborn infant.

ApgarInd
   a factor indicating whether the 5-minute Apgar score is ``< 5`` or
   ``>= 5``.

time
   a numeric vector giving the time when the sample is drawn or drug
   administered (hr).

dose
   a numeric vector giving the dose of drug administered (``u``\ g/kg).
...
During the first few days of life the infants receive multiple doses of
phenobarbital for prevention of seizures. At irregular intervals blood
samples are drawn and serum phenobarbital concentrations are determined.
