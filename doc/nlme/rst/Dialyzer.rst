.. container::
   ...
   QB
      a factor with levels ``200`` and ``300`` giving the bovine blood
      flow rate (dL/min).
   ...
   dialyzers were measured at seven different transmembrane pressures
   (in dmHg). The *in vitro* evaluation of the dialyzers used bovine
   blood at flow rates of either 200~dl/min or 300~dl/min. The data, are
   also analyzed in Littell, Milliken, Stroup, and Wolfinger (1996).
