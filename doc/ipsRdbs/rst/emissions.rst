...
Australian Traffic Accident Research Bureau @format A data frame with
thirteen columns and 54 rows.
...
CS505
   A measurement taken while running the engine from a cold start for
   505 seconds

T867
   A measurement taken while running the engine in transition from cold
   to hot for 867 seconds
