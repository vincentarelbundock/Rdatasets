...
This dataset, German_tbl_df, is a tibble containing data on the number
of errors made by 20 students when copying a German passage, both before
and after participating in an experimental German course. The dataset
provides insights into language learning and the effectiveness of the
course.
...
when
   Indicates whether the errors were recorded "before" or "after" the
   experimental course (character).

errors
   Number of errors made by the student when copying the German passage
   (integer).
