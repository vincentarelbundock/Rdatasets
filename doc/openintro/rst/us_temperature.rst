...
A representative set of monitoring locations were taken from NOAA data
in 1950 and 2022 such that the locations are sampled roughly
...
Please keep in mind that the data represent two annual snapshots, and a
complete analysis would consider more than two years of data and a
random or more complete sampling of weather stations across the US.
