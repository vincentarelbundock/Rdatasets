...
A ``table`` object of ``integer`` counts, of dimension ``42 \times 22``
...
criminals, from a paper by W. R. MacDonell (1902, p. 219). The
measurements were written out on 3000 pieces of cardboard, which were
...
The midpoints of intervals were used, e.g., where MacDonell has
...
as used in Great Britain and Ireland. *The Journal of the
