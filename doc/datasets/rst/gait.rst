...
corresponding textbooks, but with named dimensions. One record appears
to be duplicated from the original paper, Olshen et al. (1989), which
...
Gait Analysis and the Bootstrap. *Annals of Statistics* **17**, 4,
1419–1440.
...
Ramsay, J. (2023) *fda: Functional Data Analysis*. R package version
6.1.4, https://CRAN.R-project.org/package=fda.
