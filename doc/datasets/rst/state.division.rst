...
``state.center``:
   ...
   geographic center of each state in negative longitude and latitude.
   Alaska and Hawaii are placed just off the West Coast. See ‘Examples’
   on how to “correct”.
...
``state.x77``:
   matrix with 50 rows and 8 columns giving the following statistics in
