...
``steptoe.morex.geno`` is a ``cross`` object from the ``qtl`` package
with genotypic data of the 223 markers for the 150 crosses of Steptoe x
Morex.
...
``qtl::read.cross``. The class was manually changed from c('bc','cross')
to c('dh','cross').
