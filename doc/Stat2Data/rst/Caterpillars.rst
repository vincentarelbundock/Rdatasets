...
+-------------------+--------------------------------------------------+
| ``ActiveFeeding`` | Indicator (``Y`` or ``N``) of whether or not the |
|                   | animal is actively feeding                       |
+-------------------+--------------------------------------------------+
| ``Fgp``           | Indicator (``Y`` or ``N``) of whether or not the |
|                   | animal is in a free growth period                |
+-------------------+--------------------------------------------------+
| ``Mgp``           | Indicator (``Y`` or ``N``) of whether or not the |
|                   | animal is in a maximum growth period             |
+-------------------+--------------------------------------------------+
