.. container::
   ...
   Compare prices for Porsche, Jaguar, and BMW cars offered for sale at
   an internet site
   ...
   price, they recorded the model year (converting to age) and mileage
   of each advertised car. The PorschePrice dataset (from the first
   edition) has only the Porsche data and the PorscheJaguar dataset has
   the data for those two models.
