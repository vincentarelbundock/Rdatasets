.. container::
   ...
   ``Rate``
      Clearance rate (percentage radioactive particles remaining after
      one hour)
   ...
   clearance rate," that is, in English, "How fast do your lungs get rid
   of nasty stuff?" Each subject agreed to inhale an aerosol of
   ...
   remaining – the lower the better. Subjects were 15 sets of identical
   twins, each pair with one twin living in an urban environment and the
   other in a rural environment.
