...
173-179. Professor McCarthy kindly provided the data. Data loads lazily.
...
over the past 25 years. Data similar to those in TRAFFIC2.RAW should be
fairly easy to obtain for a particular state. One should combine this
information with changes in a state’s blood alcohol limit and the
passage of per se and open container laws.
