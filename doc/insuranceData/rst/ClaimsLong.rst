...
This is a simulated data set, based on the car insurance data set used
throughout the text. There are 40000 policies over 3 years, giving
120000 records.
...
``valuecat``
   vehicle value, in categories 1,...,6. (Category 1 has been recoded as
   9.), a numeric vector
