...
This dataset, cardio_diabetes_tbl_df, is a tibble containing information
comparing cardiovascular problems between two diabetes medications
(Rosiglitazone and Pioglitazone) in elderly Medicare patients. It
includes data from 227,571 patients.
...
treatment
   Type of diabetes medication (factor with 2 levels: Rosiglitazone or
   Pioglitazone)
...
The dataset name has been kept as 'cardio_diabetes_tbl_df' to avoid
...
Graham DJ, et al. (2010). "Risk of acute myocardial infarction, stroke,
heart failure, and death in elderly Medicare patients treated with
rosiglitazone or pioglitazone." JAMA, 304(4):411.
