...
classification dataset of long staying patients. Contains patients who
have been registered as an inpatient for longer than 7 days length of
stay
...
stranded.label
   binary classification label indicating whether **stranded = 1** or
   **not stranded=0**
...
care.home.referral
   flag indicating whether referred from a private care home - **1=Care
   Home Referral** and **0=Not a care home referral**
...
hcop
   flag indicating health care for older person triage - **1=Yes triaged
   from HCOP** and **0=Triaged from different department**

mental_health_care
   flag indicating whether they require mental health care - **1=MH
   assistance needed** and **0=No history of mental health**

periods_of_previous_care
   Count of the number of times they have been in hospital in last 12
   months
...
Prepared, acquired and adatped by Gary Hutson hutsons-hacks@outlook.com,
Dec-2021. Synthetic data, based off live patient data from various NHS
