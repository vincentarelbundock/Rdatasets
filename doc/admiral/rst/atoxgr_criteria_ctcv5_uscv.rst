========================== ===============
atoxgr_criteria_ctcv5_uscv R Documentation
========================== ===============
...
Metadata Holding Grading Criteria for NCI-CTCAEv5 using USCV unit where
applicable
...
``data-raw/adlb_grading/ncictcaev5_uscv.json``. The variables
...
(CTCAE)v5.0 <https://dctd.cancer.gov/research/ctep-trials/for-sites/adverse-events#ctep-ctcae>`__
