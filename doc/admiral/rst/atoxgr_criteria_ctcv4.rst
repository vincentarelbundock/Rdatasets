===================== ===============
atoxgr_criteria_ctcv4 R Documentation
===================== ===============
...
Metadata Holding Grading Criteria for NCI-CTCAEv4 using SI unit where
applicable
...
``data-raw/adlb_grading/ncictcaev4.json``. The variables
...
(CTCAE)v4.0 <https://dctd.cancer.gov/research/ctep-trials/trial-development#ctcae-and-ctep-codes>`__
...
Other metadata: ``atoxgr_criteria_ctcv4_uscv``,
``atoxgr_criteria_ctcv5``, ``atoxgr_criteria_ctcv5_uscv``,
``atoxgr_criteria_ctcv6``, ``atoxgr_criteria_ctcv6_uscv``,
