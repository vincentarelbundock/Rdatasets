========================== ===============
atoxgr_criteria_ctcv4_uscv R Documentation
========================== ===============
...
Metadata Holding Grading Criteria for NCI-CTCAEv4 using USCV unit where
applicable
...
``data-raw/adlb_grading/ncictcaev4_uscv.json``. The variables
