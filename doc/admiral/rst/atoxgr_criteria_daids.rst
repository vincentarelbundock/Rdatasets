===================== ===============
atoxgr_criteria_daids R Documentation
===================== ===============
...
Metadata Holding Grading Criteria for DAIDs using SI unit where
applicable
...
``data-raw/adlb_grading/DAIDS.json``. The variables ``GRADE_NA_CODE``,
``GRADE_4_CODE``, ``GRADE_3_CODE``, ``GRADE_2_CODE`` and
``GRADE_1_CODE`` in the json file are combined to create
...
``atoxgr_criteria_ctcv6_uscv``, ``atoxgr_criteria_daids_uscv``,
