...
Who was eliminated? Who won star baker? In the finale, who won and who
was runner up?
...
result
   ...
   values are either ``WINNER`` or ``Runner-up``. If ``NA``, the baker
...
technical
   ...
   baker/episode. A value of ``1`` means the baker was the winner of the
   technical challenge. If ``NA``, the baker did not appear in the
   episode.
