...
The dataset name has been changed to 'hsales2_ts' to avoid confusion
...
hsales2
   A numeric vector representing the monthly sales of new one-family
   houses, measured in thousands of units, from January 1987 to December
   1996.
