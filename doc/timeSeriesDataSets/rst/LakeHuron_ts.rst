...
The dataset name has been changed to 'LakeHuron_ts' to avoid confusion
...
LakeHuron
   A numeric vector representing the annual water level of Lake Huron,
   measured in feet, from 1875 to 1972.
