...
A data frame with 614 observations (185 treated, 429 control). There are
9 variables measured for each individual.
...
- "race" is the individual's race/ethnicity, (Black, Hispanic, or
  ...
  variables ``black`` and ``hispan`` instead of a single race variable.
