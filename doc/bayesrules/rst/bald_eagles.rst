...
Bald Eagle count data collected from the year 1981 to 2017, in late
...
R for Data Science TidyTuesday project. A more complete data set with a
larger selection of birds can be found in the bird_counts data in the
bayesrules package.
...
A data frame with 37 rows and 5 variables. Each row represents Bald
Eagle observations in the given year.
