...
A sub-sample of the Himalayan Database distributed through the R for
Data Science TidyTuesday project. This dataset includes information on
the results and conditions for various Himalayan climbing expeditions.
...
sex
   climber gender identity which the database oversimplifies to a binary
   category
...
Original source: https://www.himalayandatabase.com/. Complete dataset
distributed by:
