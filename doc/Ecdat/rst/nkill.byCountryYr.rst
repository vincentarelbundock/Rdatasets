...
database of incidents of terrorism from 1970 onward". Through 2020, this
database contains information on 209,706 incidents.
...
of the event for 204 countries (rows) and for all years between 1970 and
2060 (columns) except for 1993, for which the entries are all NA,
...
incidents
   ...
   NOTE: ``sum(terrorism[["incidents"]])`` = 214660 = 209706 in the GTD
...
Retrieved from https://www.start.umd.edu/gtd, 2024-10-17.
...
Sexes", `World Population Prospects
2022 <https://www.un.org/development/desa/pd/content/World-Population-Prospects-2022>`__,
published by the Population Division, World Population Prospects, of the
United Nations, accessed 2022-10-09.
