==================== ===============
AD_biomarkers_tbl_df R Documentation
==================== ===============
...
from 333 patients in a study of Alzheimer's disease biomarkers. The
study included patients with mild cognitive impairment and healthy
controls, with measurements of demographic characteristics,
apolipoprotein E genotype, protein biomarkers (including Abeta, Tau, and
pTau), and clinical dementia scores.
...
The dataset name has been kept as 'AD_biomarkers_tbl_df' to avoid
...
Craig-Schapiro R, Kuhn M, Xiong C, et al. (2011) Multiplexed Immunoassay
