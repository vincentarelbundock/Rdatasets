...
expected patterns of subcortical structures in schizophrenia derived
from large-scale meta-analyses by the ENIGMA consortium. It includes
...
The dataset name has been kept as 'subcortical_patterns_tbl_df' to avoid
