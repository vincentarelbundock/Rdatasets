...
This dataset, markers_mouse_brain_df, is a data frame containing the top
...
identified through meta-analysis of mouse brain gene expression data.
...
The dataset name has been kept as 'markers_mouse_brain_df' to avoid
...
Data taken from the BRETIGEA package version 1.0.3. Original study:
Mckenzie AT, Wang M, Hauberg ME, et al. (2018) Brain Cell Type Specific
Gene Expression and Co-expression Network Architectures. *Scientific
Reports*, 8(1), 8868.
