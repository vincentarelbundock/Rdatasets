...
retailers. Currency is in thousands of Euros. There are two data sets.
The ``SBS2000`` dataset is equal to the ``retailers`` data set except
that it has a record identifier (called ``id``) column.
